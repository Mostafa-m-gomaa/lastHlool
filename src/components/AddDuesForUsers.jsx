import { assignDuesForUser, makeOrderReady, payDues, payDuesForUser } from "@/api/orders"
...
export function AddDuesForUsers({id}) {
    ...
    const mutation =useMutation({
        mutationFn:({mutationId,values})=>assignDuesForUser(mutationId,values) ,
        onSuccess:(res)=>{
